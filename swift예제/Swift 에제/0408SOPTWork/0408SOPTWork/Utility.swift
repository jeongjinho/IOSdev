...
class DefaultAlert {
    ...
    /**
     ...
     ---
    **/
    func basicAlert(title:String, inputMessage:String, viewController: UIViewController ,alertButtonStyle:AlertButtonStyle) {
        ...
        if(alertButtonStyle == AlertButtonStyle.OneButtonStyle){
            ...
            alert.addAction(UIAlertAction(title: "확인", style: UIAlertActionStyle.default, handler: {alertAction in viewController.dismiss(animated: true, completion: nil)}))
